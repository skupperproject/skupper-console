...
const SelectTimeInterval: FC<SelectTimeIntervalProps> = function ({
  startTimeLimit,
  ...
  return (
    <div style={{ width: startLabel && endLabel ? '300px' : '170px' }}>
      <Popover
        position="bottom"
        bodyContent={
          <Card>
            <CardBody>
              <Flex>
                ...
                <FlexItem>
                  <Menu
                    onSelect={(_, value) => handleSelectFromTimeInterval(value as string)}
                    isPlain={true}
                    isScrollable
                  >
      ...
      >
        <TextInput
          style={{ cursor: 'pointer', backgroundColor: VarColors.White }}
          type="text"
          id="date-time"
          value={label}
