...
import { ServicesBytesChartProps } from '../Services.interfaces';
...
const ServicesBytesChart: FC<ServicesBytesChartProps> = function ({ bytes, labels, ...props }) {
...
export default ServicesBytesChart;
